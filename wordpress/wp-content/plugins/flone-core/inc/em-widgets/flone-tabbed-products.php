...
<div class="flone_tabbed_products_area">
	<div class="product-tab-list<?php echo esc_attr($settings['nav_style'] == '2' ? '-2' : '') ?> flone-product-tab-list nav pb-55 <?php echo esc_attr($nav_align_class); ?>">
    	...
    	?>
        <a href="#product-<?php echo esc_attr($term->slug); ?>" class="<?php echo esc_attr( $i == $active_nav ? 'active' : '' ); ?>" data-toggle="tab" >
    ...
    <div class="tab-content jump woocommerce">
        ...
        <div class="tab-pane <?php echo esc_attr( $j == $active_nav ? 'active' : '' ); ?>" id="product-<?php echo $term->slug; ?>">
					...
					while ( $wp_query->have_posts() ) {
						...
						$image_size = apply_filters( 'single_product_archive_thumbnail_size', $crop_size );
						 ...
						 ?>
						 	...
						 	<div <?php wc_product_class('col-xl-3 col-md-6 col-lg-4 col-sm-6 product'); ?>>
						...
						<?php elseif($settings['style'] == '3'): ?>
							<div <?php wc_product_class('col-md-4 col-sm-6 col-12 product'); ?>>
							...
							<?php else : ?>
								...
								<div <?php wc_product_class('col-xl-3 col-lg-4 col-md-6 col-sm-6 product'); ?>>
