<div class="httemplates-templates-area">
    <div class="httemplate-row">
        ...
        <?php if( HTBuilder_Template_Library::instance()->get_templates_info( true )['templates'] ): ?>
            ...
            <ul id="tp-grid" class="tp-grid">
                ...
                <?php foreach ( HTBuilder_Template_Library::instance()->get_templates_info( true )['templates'] as $httemplate ): 
                        ...
                        <div class="htsingle-templates-laibrary">
                            <div class="httemplate-thumbnails">
                                ...
                                <div class="httemplate-action">
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo esc_url( $httemplate['demourl'] ); ?>" target="_blank"><?php esc_html_e( 'Preview', 'ht-builder' ); ?></a>
                                </div>
                            </div>
                        ...
                        var $grid = $( '#tp-grid' ),
                            ...
                            stapel = $grid.stapel( {
                                ...
                                onBeforeOpen : function( pileName ) {
                                    $( '.htbuilder-topbar,.httemplate-action' ).css('display','flex');
